...
{
    /// <summary>
    /// Phone application page for awards_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class awards_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for awards_Detail and all its components.
        /// </summary>
        public awards_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramaawards_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramaawards_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaawards_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaawards_Detail(Panoramaawards_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaawards_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IawardsCollection>();
				AddHomeAppBarButton();
				...
				((awards_DetailViewModel)DataContext).CurrentawardsSchema = pinnedItem;				
			}
		}
