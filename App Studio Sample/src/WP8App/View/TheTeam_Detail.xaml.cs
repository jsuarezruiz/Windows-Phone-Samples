...
{
    /// <summary>
    /// Phone application page for TheTeam_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class TheTeam_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for TheTeam_Detail and all its components.
        /// </summary>
        public TheTeam_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaTheTeam_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaTheTeam_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaTheTeam_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaTheTeam_Detail(PanoramaTheTeam_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaTheTeam_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<ITheGuysCollection>();
				AddHomeAppBarButton();
				...
				((TheTeam_DetailViewModel)DataContext).CurrentTheGuysCollectionSchema = pinnedItem;				
			}
		}
